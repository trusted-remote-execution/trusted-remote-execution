...
impl fmt::Display for EntityType {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let type_str = match self {
            EntityType::Service => "systemd::Service",
            EntityType::Systemd => "systemd::Systemd",
        };
...
mod tests {
    ...
    #[rstest]
    #[case::service(EntityType::Service, "systemd::Service")]
    #[case::systemd(EntityType::Systemd, "systemd::Systemd")]
